...
export function RuleTemplateBrowser({ onInstalled }: RuleTemplateBrowserProps) {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState<TemplateRule | null>(null);
  ...
  const install = async (id: string) => {
    setInstallingId(id);
    try {
      await api.rules.installTemplate(id);
          ...
          {selectedTemplate ? (
              ...
              <div className="space-y-4 rounded-xl border border-white/5 bg-white/5 p-4">
                ...
                {selectedTemplate.metadata.content && (
                  <div className="space-y-1.5 pt-2 border-t border-white/5">
                    ...
                    <p className="text-xs text-muted-foreground italic line-clamp-6 whitespace-pre-wrap">
                      {selectedTemplate.metadata.content}
                    </p>
                  </div>
                )}
            ...
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  Browse built-in rule templates to quickly set up standards and personas.
                </DialogDescription>
